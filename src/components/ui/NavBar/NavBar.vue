<template>
  <header class="web-header">
    ...
    <div class="navBar">
      <h1><img src="../../../assets/font/153267561738953.png" alt="极速代码" /></h1>
      <ul class="navbar-pc">
  ...
  export default {
    data (){
      return {
        navList: [
          {name:"首页",url:"/"},
          {name:"技术文档",url:"/ArticleList"},
          {name:"留言板",url:"/leaveNote"},
        ],
        navindex: 0,
        phoneMenu: false,
      }
    ...
    watch: {
      ...
      phoneMenu:function(val) {
        if (!!val){
          this.Methods.OpenShade.afterOpen();
        } else {
          this.Methods.OpenShade.beforeClose();
        }
      }
    },
    mounted (){
